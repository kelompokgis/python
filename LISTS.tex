...
\section {Fungsi dan Method yang terdapat pada List}
Adapun macam-macam fungsi bawaan yang terdapat pada list yaitu :
	len(list)
 max(list)
 min(list)
 list(tuples)
 ...
 Method pada List
 Sedangkan di bawah ini adalah macam-macam method yang terdapat pada list yaitu:
 list.append(obj)
 list.count(obj)
 list.extend(seq)
 list.index(obj)
